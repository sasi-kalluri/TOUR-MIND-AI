        ...
        import { MapPin, Navigation, AlertTriangle, MessageSquare, User, LogOut, Sun, Moon, Compass, Send, Shield, Info, Star, X, Users, ArrowRight, Bell, Check, Trash2, Calendar, Search, Link, CheckCircle, Upload } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const handleSOS = () => {
            ...
            ), { duration: 10000, icon: 'ðŸš¨', style: { border: '2px solid #ef4444', color: '#b91c1c', background: '#fef2f2' } });
    ...
    const handleVerificationSubmit = async (e) => {
        ...
        <div className="min-h-screen bg-slate-50 relative font-sans">
            ...
            < main className={ ` ${activeTab === 'map' ? 'relative w-full h-[calc(100vh-70px)] overflow-hidden bg-slate-900' : 'w-[90%] md:w-[85%] max-w-[1600px] mx-auto py-8 mb-20 md:mb-0 transition-all duration-500'}` }>
                                    ...
                                    <div className="space-y-8 relative z-10">
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            <div className="relative group/bud">
                                                ...
                                                <div className="relative">
                                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 font-black text-lg">â‚¹</span>
                                                    <input
                                                        type="number"
                                            ...
                                            <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50/80 to-indigo-50/80 rounded-2xl border border-blue-100 backdrop-blur-sm shadow-inner mb-6">
                                                <div className="flex items-center gap-4">
                                                    <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-2xl filter drop-shadow hover:scale-110 transition-transform">
                                                        { ['â˜€ï¸', 'â›…', 'ðŸŒ§ï¸', 'âš¡'][Math.floor(Math.random() * 4)] }
                                                    </div>
                                                    <div>
                                                        ...
                                                        <p className="text-sm font-bold text-slate-700 flex items-center gap-2">
                                                            ...
                                                            { planData.destination && <span className="px-2 py-0.5 bg-white rounded-md text-[10px] shadow-sm text-slate-500">24Â°C</span> }
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="bg-white rounded-[2.5rem] p-8 mb-8 shadow-sm border border-slate-100">
                                <div className="flex flex-col md:flex-row justify-between items-end gap-6">
                                    ...
                                    <div className="text-right bg-emerald-50 px-6 py-4 rounded-2xl border border-emerald-100 text-emerald-900">
                                        ...
                                        <p className="text-3xl font-black tracking-tight">{ itinerary.stats?.cost || 'â‚¹' + planData.budget }</p>
                                    </div>
                                </div>
                            </div>
                ...
                {
                    activeTab === 'trips' && (
                        <div className="min-h-screen pb-24 animate-in fade-in slide-in-from-bottom-4">
                                ...
                                >
                                    { myTrips.filter(trip => trip.plan?.status).map((trip) => (
                                        <motion.div
                                            ...
                                            whileHover={ { y: -8, boxShadow: "0 25px 50px -12px rgba(79, 70, 229, 0.3)" } }
                                            className="bg-white p-6 rounded-[2rem] border border-slate-100 shadow-sm group relative overflow-hidden"
                                        >
                                            <div className="flex justify-between items-start mb-4">
                                                <div>
                                            ...
                                            <div className="space-y-3 mb-6">
                                                ...
                                                <div className="flex items-center gap-3 text-sm font-medium text-slate-600">
                                                    ...
                                                    <span>â‚¹{ trip.stats?.cost || trip.budget } Budget</span>
                                                </div>
                                                <div className="flex items-center gap-3 text-sm font-medium text-slate-600">
                                            ...
                                            { (trip.plan?.status === 'Confirmed') ? (
                                                (trip.plan?.schedule) ? (
                                                    <button
                                                        ...
                                                        className="w-full py-4 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-black transition-colors flex items-center justify-center gap-2 group-hover:translate-y-0 translate-y-2 opacity-90 group-hover:opacity-100"
                                                    >
                ...
                {/* MAP TAB */ }
                {
                    activeTab === 'map' && (
                        <>
                            ...
                            <div className="absolute top-6 left-6 z-[400] max-w-sm">
                                <div className="bg-white/80 backdrop-blur-xl p-5 rounded-3xl shadow-2xl border border-white/40">
                                    <div className="flex items-start gap-4">
                                        <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-violet-600 rounded-2xl flex items-center justify-center text-white shadow-lg shadow-indigo-200">
                                            <Shield size={ 20 } strokeWidth={ 2.5 } />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-slate-800 leading-tight">Safety Monitoring</h3>
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className={ `relative flex h-2.5 w-2.5` }>
                                                    <span className={ `absolute inline-flex h-full w-full rounded-full opacity-75 ${gpsEnabled ? 'bg-emerald-400' : 'bg-slate-400'}` }></span>
                                                    <span className={ `relative inline-flex rounded-full h-2.5 w-2.5 ${gpsEnabled ? 'bg-emerald-500' : 'bg-slate-500'}` }></span>
                                                </span>
                                                <p className="text-xs font-medium text-slate-500">{ gpsEnabled ? 'Active & Tracking' : 'GPS Offline' }</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="absolute bottom-28 right-6 z-[400] flex flex-col gap-3">
                                <button
            ...
            < div className="fixed bottom-6 right-6 z-[1001] flex flex-col items-end" >
                { chatOpen && (
                    <div className="mb-4 bg-white w-[360px] md:w-[420px] h-[600px] rounded-[2.5rem] shadow-2xl border border-slate-100 flex flex-col overflow-hidden relative">
                        {/* Chat Header */ }
                        <div className="bg-white/90 backdrop-blur-sm p-5 border-b border-slate-100 absolute top-0 left-0 right-0 z-10 flex justify-between items-center">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 bg-gradient-to-tr from-indigo-500 to-violet-600 rounded-full flex items-center justify-center text-white shadow-md">
                                    <Compass size={ 20 } />
                                </div>
                                <div>
                            ...
                            <button onClick={ () => setChatOpen(false) } className="w-8 h-8 flex items-center justify-center rounded-full bg-slate-50 text-slate-400 hover:bg-slate-100 hover:text-slate-600 transition-colors">
                                <X size={ 18 } />
                            </button>
                        </div>

                        {/* Messages Area */ }
                        <div className="flex-1 overflow-y-auto p-5 pt-24 space-y-6 bg-slate-50/50">
                            { messages.length === 0 && (
                                <div className="flex flex-col items-center justify-center h-full text-center opacity-50 mt-10">
                                    <MessageSquare size={ 48 } className="text-slate-300 mb-4" />
                                    <p className="text-sm font-bold text-slate-400">Ask me anything about<br />your trip!</p>
                                </div>
                            ) }
                            { messages.map((msg, i) => (
                        ...
                        <form onSubmit={ handleChatSubmit } className="p-4 bg-white border-t border-slate-100">
                            <div className="flex items-center gap-2 bg-slate-50 p-1.5 rounded-full border border-slate-200 focus-within:ring-2 focus-within:ring-indigo-100 transition-all">
                                <input
                                    className="flex-1 bg-transparent px-4 text-sm font-medium text-slate-800 placeholder:text-slate-400 outline-none"
                ...
                <button
                    ...
                    className={ `w-16 h-16 rounded-full shadow-[0_20px_40px_-10px_rgba(79,70,229,0.5)] transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center border-4 border-white ${chatOpen ? 'bg-slate-800 text-white rotate-90' : 'bg-gradient-to-tr from-indigo-600 to-violet-600 text-white'}` }
                >
                    { chatOpen ? <X size={ 28 } /> : <MessageSquare size={ 28 } fill="currentColor" /> }
                </button>
            </div >
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 animate-in fade-in">
                        <div className="bg-white rounded-3xl w-full max-w-lg shadow-2xl overflow-hidden animate-in zoom-in-95 relative">
                            ...
                            <form onSubmit={ handleBookSubmit } className="p-8 space-y-4">
                                <p className="text-sm text-center text-slate-500 font-medium">âœ¨ Enter your details and we will craft the perfect trip for you.</p>
